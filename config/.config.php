...
$_ENV['code_payback'] = 20; //Recharge rebate percentage
...
$_ENV['telegram_chatid'] = ''; //Telegram bot, group session ID, you can get it by pulling the robot into the group and /ping him
