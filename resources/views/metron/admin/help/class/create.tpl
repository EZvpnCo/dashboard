...
<main class="content">
    <div class="content-header ui-content-header">
        <div class="container">
            <h1 class="content-heading">To create a classification</h1>
        </div>
    </div>
    <div class="container">
                ...
                <div class="card">
                    <div class="card-main">
                        <div class="card-inner">
                            ...
                            <div class="form-group form-group-label">
                                <label class="floating-label" for="ico">icon</label>
                                    ...
                                    <div class="col-md-10 col-md-push-1">
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="is_1ji">
                                                    <input class="access-hide" id="is_1ji" type="radio" name="is_dji" value="1"><span class="switch-toggle"></span>Set to the level of classification
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="is_2ji">
                                                    <input class="access-hide" id="is_2ji" type="radio" name="is_dji" value="2"><span class="switch-toggle"></span>Set to the secondary classification
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="pageshow">
                                                    <input class="access-hide" id="pageshow" type="checkbox" checked='checked' name="pageshow"><span class="switch-toggle"></span>The classification and page is shown
                                                </label>
