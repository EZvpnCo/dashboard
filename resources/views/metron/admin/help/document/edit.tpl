...
<main class="content">
    <div class="content-header ui-content-header">
        <div class="container">
            <h1 class="content-heading">Edit the document</h1>
        </div>
    </div>
    <div class="container">
                                    ...
                                    <div class="col-md-10 col-md-push-1">
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="isontop">
                                                    <input class="access-hide" id="isontop" type="checkbox" name="isontop" {if $help->ontop==1}checked{/if}><span class="switch-toggle"></span>Whether top on
                                                </label>
                                            </div>
                                        </div>

                                        <button id="submit" type="submit" class="btn btn-block btn-brand waves-attach waves-light">Modify the
                                        </button>
                                    </div>
                                </div>
                            </div>
