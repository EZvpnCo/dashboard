                                    ...
                                    <div class="card p-5  mb-8 {$metron['style_shadow']}">
                                        <div class="card-header" id="faqHeading2-{$content->id}">
                                            ...
                                            <div class="card-title collapsed pt-0" data-toggle="collapse" data-target="#faq2-{$content->id}" aria-expanded="true" aria-controls="faq1-{$content->id}">
                                                <footer class="blockquote-footer"><cite title="The primary classification">{$classs[ $classs[$content->class]['upid'] ]['name']}</cite>&nbsp;&nbsp;-&nbsp;<cite title="The secondary classification">{$classs[$content->class]['name']}</cite></footer>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-custom p-6 mb-8 mb-lg-0 {$metron['style_shadow']}">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        <div class="mr-4">
                                            <h3 class="{$style[$theme_style]['global']['title']} mb-6">Document center couldn't solve the problem?</h3>
                                            <p class="text-dark-50 font-size-lg">If the content of the document center does not solve your problem, Through the repair order and contact us<br>Open before the repair order, Please make sure that the content of the document center does not provide help for you</p>
                                        </div>
                                        <a href="/user/ticket" class="btn font-weight-bolder text-uppercase font-size-lg btn-primary py-3 px-6">Contact us</a>
                                    </div>
                                </div>
