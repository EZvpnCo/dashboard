                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card card-custom overflow-hidden position-relative mb-8 {$metron['style_shadow']}">
                                                ...
                                                <form class="d-flex position-relative flex-row-fluid">
                                                    <div class="input-group shadow-sm">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text {$style[$theme_style]['help']['search_bg']} border-0 py-7 px-8">
                                                        ...
                                                        <input type="text" class="form-control h-auto border-0 py-7 px-1 font-size-lg" placeholder="Find your problem" name="Keywords" id="Keywords" value="{$Keywords}" />
                                            ...
                                            <div class="position-relative px-20">
                                                <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                                                    ...
                                                    <li class="nav-item mr-14 mt-4">
                                                        <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0 {if $pageType == $list_L1->id} active {/if}" href="/user/help?type={$list_L1->name}" >{if $list_L1->li != null}<span class="{$list_L1->li}"></span>&nbsp;{/if}{$list_L1->name}</a>
                                                    </li>
                                                    {/foreach}
                                                </ul>
                                            </div>
