...
<html lang="en">
    <head>
        <title>The little black house &mdash; {$config["appName"]}</title>
                            ...
                            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                <div class="d-flex align-items-center flex-wrap mr-2">
                                    <div class="d-flex flex-column">
                                        <h2 class="text-white font-weight-bold my-2 mr-5">Account has been banned</h2>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card card-custom gutter-b {$metron['style_shadow']}">
                                            ...
                                            <div class="pb-20 pt-10 text-center">
                                                <h3 class="display-4 text-center font-weight-bolder">Your account has been banned</h3>
                                                <h3 class="display-4 text-center font-weight-bolder">If you have any questions please send the repair order</h3>
                                            </div>
                                        </div>
