...
<html lang="en">
<head>
    <title>The node list &mdash; {$config["appName"]}</title>
                                        ...
                                        <ul class="list-unstyled user-details list-unstyled-border list-unstyled-noborder">
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span class="label label-dot label-xl {if $node['online']=='1'}label-success{else}label-danger{/if}"></span>
                                                    {$node['name']}
                                                    </div>
        ...
        <div class="modal fade" id="nodes-filter-modal" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title {$style[$theme_style]['modal']['text_title']}"><strong> Subscribe to the node selection </strong>
                        </h5>
                                            ...
                                            <div class="kt-form__group kt-form__group--inline">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <select class="form-control" id="filter_mininame">
                                                        <option value="1"
                                                                {if $filter['mininame']===1}selected="selected"{/if}>open
                                                        </option>
                                                        <option value="0"
                                    ...
                                    <div class="dropdown-menu">
                                        {foreach $metron['node_class_name'] as $nodeName}
                                            <button type="button" class="dropdown-item"
                                                ...
                                                Select all the Lv.{$nodeName@key} {$nodeName}</button>
                                        {/foreach}
                                    </div>
                                </div>
                                <div class="btn-group kt-padding-r-10"
                                ...
                                {if $node['class'] != $filter_class}
                                    ...
                                    <div class="col-12 pl-0 pt-5 pb-2 text-center">
                                        <h3 class="display-5 text-primary">
                                            <strong>{$metron['node_class_name'][$filter_class]}</strong>{if $user->class<$filter_class} [Insufficient level]{/if}
                                        </h3>
                                    </div>
                                {/if}
