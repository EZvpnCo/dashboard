            ...
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <ul>
                            <li><a href="/" data-i18n="dashboard">The store</a></li>
                            <li><a href="/" data-i18n="dashboard">The node list</a></li>
                            <li><a href="/" data-i18n="dashboard">Invitation to register</a></li>
                            <li><a href="/" data-i18n="dashboard">To download and use</a></li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <h4>{$i18n->get('support')}</h4>
                        <ul>
                            <li><a href="/" data-i18n="dashboard">Contact us</a></li>
                            <li><a href="/" data-i18n="dashboard">The new construction of single</a></li>
                            <li><a href="/" data-i18n="dashboard">Q&A</a></li>
                            <li><a href="/" data-i18n="dashboard">join Telegram group</a></li>
                        </ul>
                    </div>
                </div>
            </div>
