...
/* Smarty version 3.1.47, created on 2022-12-04 03:07:22
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron/include/global/menu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_638b9e6a36cc34_21612456',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '77d607a4241f4bab4313681864b082453715df5a' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron/include/global/menu.tpl',
      1 => 1670092670,
      2 => 'file',
    ),
  ),
...
function content_638b9e6a36cc34_21612456 (Smarty_Internal_Template $_smarty_tpl) {
                            ...
                            <div class="d-flex align-items-stretch mr-3">
                                ...
                                <div class="header-logo">
                                    <a href="/user">
                                        ...
                                        <h2 class="logo-sticky"><?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
</h1>
                                    </a>
                                </div>
                                ...
                                <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                                    <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
                                        ...
                                        <ul class="menu-nav">
                                            ...
                                            <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                                ...
                                                <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                                    <ul class="menu-subnav">
                                                        ...
                                                        <?php if ($_smarty_tpl->tpl_vars['metron']->value['node_relay_enable'] === true) {?>
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="/user/setting/relay" class="menu-link">
                                                                ...
                                                                <span class="menu-text">Node transit</span>
                                                            </a>
                                                        </li>
                                                        <?php }?>
                                                        <li class="menu-item" aria-haspopup="true">
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['metron']->value['shared_account_enable'] === true) {?>
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                                <a href="/user/shared_account" class="menu-link">
                                                    <span class="menu-text"><strong>A Shared account</strong></span>
                                                </a>
                                            </li>
                                            <?php }?>
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['metron']->value['agent_menu_enable'] === true && $_smarty_tpl->tpl_vars['user']->value->agent > 0) {?>
                                            <li class="menu-item menu-item-submenu menu-item-rel">
                                        ...
                                        <ul class="navi navi-hover py-4">
                                            <li class="navi-item">
                                                <a href="JavaScript:;" class="navi-link" onclick="mt.changeTheme('primary');">
                                                    <span class="svg-icon <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['svg'];?>
 svg-icon-2x mr-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                <polygon points="0 0 24 0 24 24 0 24"/>
                                ...
                                <div class="dropdown">
                                    <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                                        <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto">
                                            ...
                                            <span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4"><?php echo $_smarty_tpl->tpl_vars['user']->value->user_name;?>
</span>
...
" alt="" />
                                            ...
                                            <div class="<?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title'];?>
 m-0 flex-grow-1 mr-3 font-size-h5">&nbsp;<strong><?php echo $_smarty_tpl->tpl_vars['user']->value->user_name;?>
</strong></div>
                                        ...
                                        <div class="navi navi-spacer-x-0 pt-5">
                                            ...
                                            <div class="navi-footer px-8 py-5">
                                                <a href="/user/logout" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close'];?>
 font-weight-bold">Log out</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
