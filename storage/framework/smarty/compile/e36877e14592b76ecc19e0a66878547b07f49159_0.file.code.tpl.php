<?php
/* Smarty version 3.1.47, created on 2022-10-16 22:36:49
  from '/www/wwwroot/subscribe/resources/views/metron/user/code.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
    'version' => '3.1.47',
    'unifunc' => 'content_634c1701461a96_90693598',
    'has_nocache_code' => false,
    'file_dependency' =>
    array(
        'e36877e14592b76ecc19e0a66878547b07f49159' =>
        array(
            0 => '/www/wwwroot/subscribe/resources/views/metron/user/code.tpl',
            1 => 1665876375,
            2 => 'file',
        ),
    ),
    ...
    function content_634c1701461a96_90693598(Smarty_Internal_Template $_smarty_tpl)
    {
?>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <head>
            <title>我的钱包 &mdash; <?php echo $_smarty_tpl->tpl_vars['config']->value["appName"]; ?>
            </title>
...
/media/svg/patterns/taieri.svg)">
 ...
 font-weight-bolder my-7">钱包余额</h3>
                                                        <p class="<?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title']; ?>
 display-2 display1-lg pb-10" style="padding-top: 10px; padding-bottom: 10px"><span class="display-4"><strong>¥</strong> </span><strong><?php echo $_smarty_tpl->tpl_vars['user']->value->money; ?>
                                                            </strong></p>
                                                        <a href="Javascript:;" class="btn btn-danger font-weight-bold px-6 py-3" onclick="code.payTab();">余额充值</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="code-setmoney" class="card card-custom bgi-no-repeat gutter-b card-stretch <?php echo $_smarty_tpl->tpl_vars['metron']->value['style_shadow']; ?>
" style="display: none; min-height: 400px; background-position: right top; background-size: 30% auto; background-image: url(<?php echo $_smarty_tpl->tpl_vars['metron']->value['assets_url']; ?>
/media/svg/shapes/abstract-3.svg)">
 ...
 font-weight-bold font-size-h3">
                                                            <i class="fab fa-cc-amazon-pay icon-lg <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title']; ?>
"></i><strong>&nbsp;&nbsp;余额充值</strong>
...
">
                                                <div class="card-header flex-wrap border-0 pt-6">
                                                    <div class="card-title">
                                                        <h3 class="card-label <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title']; ?>
"><strong>充值记录</strong>
                                                            <span class="d-block text-muted pt-2 font-size-sm">成功充值的记录</span>
                                                        </h3>
                                                    </div>
                                                </div>
...
">
                                                <div class="card-header flex-wrap border-0 pt-6">
                                                    <div class="card-title">
                                                        <h3 class="card-label <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title']; ?>
"><strong>支付订单记录</strong>
                                                            <span class="d-block text-muted pt-2 font-size-sm">当前账号下所有支付订单记录</span>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div class="card-body">
...
">
                                                <div class="card-header flex-wrap border-0 pt-6">
                                                    <div class="card-title">
                                                        <h3 class="card-label <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title']; ?>
"><strong>套餐记录</strong>
                                                            <span class="d-block text-muted pt-2 font-size-sm">当前账号下所有购买的套餐商品</span>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div class="card-body">
...
"><strong>选择支付方式</strong></h4>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="metronPay_input" onclick="code.metronPay('<?php echo $_smarty_tpl->tpl_vars['config']->value['payment_system']; ?>
', '', '0', '');">确定</button>
                            <button type="button" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close']; ?>
...
"><strong>选择支付方式</strong></h4>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="metronPay_restart_input" onclick="code.metronPay_restart('<?php echo $_smarty_tpl->tpl_vars['config']->value['payment_system']; ?>
', '', '0', '');">确定</button>
                            <button type="button" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close']; ?>
 font-weight-bold" data-dismiss="modal">取消</button>
                        </div>
            ...
            <div class="modal fade" id="PackageConversion-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content shadow-lg">
                        <div class="modal-header">
                            <h4 class="modal-title <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['text_title']; ?>
" id="exampleModalLongTitle"><strong>折算确认</strong></h4>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close']; ?>
 font-weight-bold" data-dismiss="modal" onclick="">取消</button>
                        </div>
                    </div>
                </div>
            </div>
