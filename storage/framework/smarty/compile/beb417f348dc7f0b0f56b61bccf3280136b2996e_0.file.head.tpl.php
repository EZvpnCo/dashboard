<?php
/* Smarty version 3.1.47, created on 2022-12-04 03:07:51
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron/user/help/head.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_638b9e8796af63_05981041',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'beb417f348dc7f0b0f56b61bccf3280136b2996e' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron/user/help/head.tpl',
      1 => 1670092670,
      2 => 'file',
    ),
  ),
...
function content_638b9e8796af63_05981041 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>Document center &mdash; <?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
</title>
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card card-custom overflow-hidden position-relative mb-8 <?php echo $_smarty_tpl->tpl_vars['metron']->value['style_shadow'];?>
">
                                            ...
                                            <div class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40">
                                                <h2 class="<?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['title'];?>
 font-weight-bolder mb-8">What can we help you?</h2>
                                                <form class="d-flex position-relative flex-row-fluid">
                                                    <div class="input-group shadow-sm">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['help']['search_bg'];?>
 border-0 py-7 px-8">
                                                        ...
                                                        <input type="text" class="form-control h-auto border-0 py-7 px-1 font-size-lg" placeholder="Find your problem" name="Keywords" id="Keywords" value="<?php echo $_smarty_tpl->tpl_vars['Keywords']->value;?>
" />
                                                        <div class="input-group-append">
                                                            <button type="submit" class="btn btn-primary btn-lg" id="search" onclick="help.search();">search</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
?>
                                                    <li class="nav-item mr-14 mt-4">
                                                        <a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0 <?php if ($_smarty_tpl->tpl_vars['pageType']->value == $_smarty_tpl->tpl_vars['list_L1']->value->id) {?> active <?php }?>" href="/user/help?type=<?php echo $_smarty_tpl->tpl_vars['list_L1']->value->name;?>
" ><?php if ($_smarty_tpl->tpl_vars['list_L1']->value->li != null) {?><span class="<?php echo $_smarty_tpl->tpl_vars['list_L1']->value->li;?>
"></span>&nbsp;<?php }
echo $_smarty_tpl->tpl_vars['list_L1']->value->name;?>
</a>
                                                    </li>
                                                    <?php
}
