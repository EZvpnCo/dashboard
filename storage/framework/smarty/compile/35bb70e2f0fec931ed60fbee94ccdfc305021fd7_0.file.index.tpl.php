<?php
/* Smarty version 3.1.47, created on 2022-12-09 20:00:35
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron/user/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_63932363d597d5_46424563',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35bb70e2f0fec931ed60fbee94ccdfc305021fd7' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron/user/index.tpl',
      1 => 1670585647,
      2 => 'file',
    ),
  ),
...
function content_63932363d597d5_46424563 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <title>The user center &mdash; <?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
</title>
...
?>
 ...
 font-weight-bold py-3 px-6"
                                       id="checkin" onclick="index.checkin();">Daily check</a>
                                <?php } else { ?>
                                    <a href="javascript:;"
...
">
 ...
 mb-2">
                                                            <strong><?php if ($_smarty_tpl->tpl_vars['user']->value->class_expire != "1989-06-04 00:05:00" && $_smarty_tpl->tpl_vars['user']->value->class >= 1) {?>
                                                                    ...
                                                                    day<?php } elseif ($_smarty_tpl->tpl_vars['user']->value->class <= 0) {?>
                                                                    <span class="counter">expired</span>
                                                                <?php } else { ?>The unknown<?php }?></strong></div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 Due to
                                                    ...
                                                    <?php } elseif ($_smarty_tpl->tpl_vars['user']->value->class == -1) {?>
                                                        Please buy package to activate account
                                                    <?php } else { ?>permanent<?php }?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
">
 ...
 mb-2">
                                            ...
                                            <div class="card-body pt-2 pl-5 pr-3 pb-1">
                                                <p class="text-dark-50">The next time reset:<?php echo $_smarty_tpl->tpl_vars['user']->value->valid_use_loop();?>
...
echo $_smarty_tpl->tpl_vars['user']->value->node_connector;
                                            ...
                                            <div class="card-body pt-2 pl-5 pr-3 pb-1">
                                                <p class="text-dark-50">
                                                    The last time to use: <?php if ($_smarty_tpl->tpl_vars['user']->value->lastSsTime() == 'Never use meow') {?>Never used<?php } else {
...
">
 ...
 mb-2">
                                            ...
                                            <div class="card-body pt-2 pl-5 pr-3 pb-1">
                                                <p class="text-dark-50">Rebate cumulative: ¥ <?php echo $_smarty_tpl->tpl_vars['paybacks_sum']->value;?>
</p>
                                            </div>
                                        </div>
                                    </div>
...
"></i><strong>
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div id="NodeTrafficChart_null" class="text-center p-10"
                                                     style="display: none;">
                                                    <h3 class="display-5 text-muted">No record</h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-5 mt-2 text-center"
                                                    style="color:#191d21d5">Follow these steps to start using it!</h5>
                                                <div class="row mt-4">
                                                        ...
                                                        <div class="wizard-steps">
                                                            <div class="wizard-step wizard-step-active"
                                                                ...
                                                                <div class="wizard-step-label">
                                                                    Went to the store to buy membership subscription plans or free trial
                                                                </div>
                                                            </div>
                                                            <div class="wizard-step wizard-step-active"
                                                                ...
                                                                <div class="wizard-step-label">
                                                                    Download the client according to the tutorial and installation
                                                                </div>
                                                            </div>
...
"
                        id="qrcode-sublink-modal-title"><strong>Code qr code to add subscription</strong></h4>
                </div>
...
"
                    ...
                    <div class="modal-body">
                        <label class="row col-12 col-form-label kt-font-boldest">Your package to reset the date for:<code><?php echo $_smarty_tpl->tpl_vars['user']->value->valid_use_loop();?>

                                00:00 </code> </label>
                        <label class="row col-12 col-form-label kt-font-boldest" id="ResetFlow_day"></label>
                        <div class="kt-divider mt-4 mb-4"><span></span><span>According to the distance a date for the next reset in proportion to reset the flow for you</span><span></span>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                                id="advanceResetFlow-modal-ok" onclick="index.advanceResetFlow('set');">determine
                        </button>
                        <button type="button" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close'];?>
 font-weight-bold"
...
"
                ...
                <div class="modal-body">
                    Your package has expired or are not buy package, please purchase package after use
                </div>
                <div class="modal-footer">
...
" role="alert">\
                    ...
                    <div class="alert-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Your traffic Please pay attention to useeen inadequate 5GB, Please pay attention to use! </font></font></div>\
                </div>\
            ');
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['user']->value->class === -1) {?>
...
" role="alert">\
                    ...
                    <div class="alert-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Your account has not been activated, Please go to the shop to buy package to activate it! </font></font></div>\
                </div>\
            ');
        <?php }?>
    <?php echo '</script'; ?>
