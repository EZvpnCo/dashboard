<?php
/* Smarty version 3.1.47, created on 2022-12-03 20:12:14
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron/admin/user/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_638b3d1e3733a1_63210498',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '062f7162c07707296779695e455332428cccd280' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron/admin/user/index.tpl',
      1 => 1670053668,
      2 => 'file',
    ),
  ),
...
function content_638b3d1e3733a1_63210498 (Smarty_Internal_Template $_smarty_tpl) {
                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    <p>
                                        Paying customers：<?php echo $_smarty_tpl->tpl_vars['user']->value->paidUserCount();?>

                                    </p>
                                    <p>
                                        The total user：<?php echo $_smarty_tpl->tpl_vars['user']->value->allUserCount();?>

                                    </p>
                                    <p>
                                        Conversion rate：<?php echo $_smarty_tpl->tpl_vars['user']->value->transformation();?>
...
?>
                ...
                error: jqXHR => {
                    $("#result").modal();
                    $$.getElementById('msg').innerHTML = `${jqXHR} An error has occurred。`;
                }
            });
        }
