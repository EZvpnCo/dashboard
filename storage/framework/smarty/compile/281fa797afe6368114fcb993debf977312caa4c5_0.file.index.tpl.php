...
/* Smarty version 3.1.47, created on 2022-12-01 04:38:54
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron-en/user/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_6387bf5e5839d8_27475640',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '281fa797afe6368114fcb993debf977312caa4c5' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron-en/user/index.tpl',
      1 => 1669804400,
      2 => 'file',
    ),
  ),
...
function content_6387bf5e5839d8_27475640 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <title>User Center &mdash; <?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
</title>
...
?>
 ...
 font-weight-bold py-3 px-6"
                                       id="checkin" onclick="index.checkin();">Daily check-in</a>
                                <?php } else { ?>
                                    <a href="javascript:;"
                                       class="btn btn-transparent-white font-weight-bold py-3 px-6 mr-2 disabled"
                                       disabled="disabled">signed in</a>
                                <?php }?>
                            </div>
                        </div>
                    </div>
...
">
 ...
 mb-2">
                                                            <strong><?php if ($_smarty_tpl->tpl_vars['user']->value->class_expire != "1989-06-04 00:05:00" && $_smarty_tpl->tpl_vars['user']->value->class >= 1) {?>
                                                                ...
                                                                <?php } else { ?>unknown<?php }?></strong></div>
                                                        <p class="text-dark-50">Membership duration</p>
                                                    </div>
                                                </div>
                                            </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 maturity
                                                    ...
                                                    <?php } elseif ($_smarty_tpl->tpl_vars['user']->value->class == -1) {?>
                                                        Please purchase a package to activate the account
                                                    <?php } else { ?>永久<?php }?>
                                                </p>
                                            </div>
                                        </div>
...
">
 ...
 mb-2">
                                                        ...
                                                        <p class="text-dark-50">residual flow</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-2 pl-5 pr-3 pb-1">
                                                <p class="text-dark-50">next reset：<?php echo $_smarty_tpl->tpl_vars['user']->value->valid_use_loop();?>
 ...
 label-inline font-weight-lighter ml-1 mr-2 cursor_onclick"
                                                              onclick="index.advanceResetFlow('get');">Early reset</span>
                                                    <?php }?>
                                                </p>
                                            </div>
                                        </div>
...
">
 ...
 mb-2">
                                                            <strong><?php echo $_smarty_tpl->tpl_vars['user']->value->online_ip_count();?>
                                                                ...
                                                                / <?php if ($_smarty_tpl->tpl_vars['user']->value->node_connector == 0) {?>unlimited<?php } else {
echo $_smarty_tpl->tpl_vars['user']->value->node_connector;
}?></strong>
                                                        </div>
                                                        <p class="text-dark-50">online device</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-2 pl-5 pr-3 pb-1">
                                                <p class="text-dark-50">
                                                    last used: <?php if ($_smarty_tpl->tpl_vars['user']->value->lastSsTime() == 'never used meow') {?>never used<?php } else {
...
">
 ...
 mb-2">
                                                        ...
                                                        <p class="text-dark-50">wallet balance</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-2 pl-5 pr-3 pb-1">
                                                <p class="text-dark-50">Rebate accumulation: ¥ <?php echo $_smarty_tpl->tpl_vars['paybacks_sum']->value;?>
</p>
                                            </div>
                                        </div>
                                    </div>
...
"></i><strong>
                                                        ...
                                                        <div class="font-size-sm text-muted mt-2">
                                                            Updated：<?php echo $_smarty_tpl->tpl_vars['ann']->value->date;?>
</div>
                                                    </div>
                                                </div>
                                            </div>
...
"></i><strong>
                                                        ...
                                                        <div class="font-size-sm text-muted mt-2">Generate traffic over 72 hours 10 MB
                                                            node statistics
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div id="NodeTrafficChart_null" class="text-center p-10"
                                                     style="display: none;">
                                                    <h3 class="display-5 text-muted">No records</h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-5 mt-2 text-center"
                                                    style="color:#191d21d5">Follow the steps below to get started!</h5>
                                                <div class="row mt-4">
                                                        ...
                                                        <div class="wizard-steps">
                                                            <div class="wizard-step wizard-step-active"
                                                                ...
                                                                <div class="wizard-step-label">
                                                                    Go to the store to purchase a membership subscription plan or a free trial
                                                                </div>
                                                            </div>
                                                            <div class="wizard-step wizard-step-active"
                                                                ...
                                                                <div class="wizard-step-label">
                                                                    Download the client and install it according to the tutorial
                                                                </div>
                                                            </div>
...
"
                        id="qrcode-sublink-modal-title"><strong>Scan QR code to add subscription</strong></h4>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content shadow-lg">
                    <div class="modal-header">
                        <h4 class="modal-title <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['text_title'];?>
"
                            id="advanceResetFlow-modal-title"><strong>Traffic Reset Confirmation</strong></h4>
                    </div>
                    <div class="modal-body">
                        <label class="row col-12 col-form-label kt-font-boldest">Your plan reset date is：<code><?php echo $_smarty_tpl->tpl_vars['user']->value->valid_use_loop();?>

                                00:00 </code> </label>
                        <label class="row col-12 col-form-label kt-font-boldest" id="ResetFlow_day"></label>
                        <div class="kt-divider mt-4 mb-4"><span></span><span>Reset traffic for you proportionally based on the date until the next reset</span><span></span>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal"
                                id="advanceResetFlow-modal-ok" onclick="index.advanceResetFlow('set');">Sure
                        </button>
                        <button type="button" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close'];?>
 font-weight-bold"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content shadow-lg">
                <div class="modal-header">
                    <h4 class="modal-title <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['text_title'];?>
"
                        id="qrcode-sublink-modal-title"><strong>Account level expired</strong></h4>
                </div>
                <div class="modal-body">
                    Your package has expired or you have not purchased a package yet, please purchase a package first and then use it
                </div>
                <div class="modal-footer">
                    <a href="/user/shop" class="btn btn-primary">Go to buy</a>
                    <button type="button" class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['btn_close'];?>
 font-weight-bold"
...
" role="alert">\
                    ...
                    <div class="alert-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Your traffic is less than 5GB, please pay attention! </font ></font></div>\
                </div>\
            ');
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['user']->value->class === -1) {?>
...
" role="alert">\
                    ...
                    <div class="alert-text"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Your account has not been activated yet, please go to the store to purchase a package to activate Account! </font></font></div>\
                </div>\
            ');
        <?php }?>
    <?php echo '</script'; ?>
