...
/* Smarty version 3.1.47, created on 2022-12-04 05:05:31
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron/include/settings/menu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_638bba1bde3d35_02130098',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ba703e4e85ce2f5e53070a558bbe84f52c57bdde' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron/include/settings/menu.tpl',
      1 => 1670092670,
      2 => 'file',
    ),
  ),
...
function content_638bba1bde3d35_02130098 (Smarty_Internal_Template $_smarty_tpl) {
?>                                <div class="d-flex align-items-center">
                                    <button class="btn <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['global']['btn_subheader'];?>
 font-weight-bold mr-4 d-inline-block d-lg-none" id="user_profile_mobile_toggle">The menu</button>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="card-body pt-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                                        <div class="symbol-label" style="background-image:url(<?php echo $_smarty_tpl->tpl_vars['user']->value->gravatar;?>
)"></div>
                                                        <i class="symbol-badge bg-success"></i>
                                                    </div>
                                                    <div>
                                                        <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?php echo $_smarty_tpl->tpl_vars['user']->value->user_name;?>
</a>
                                                ...
                                                <div class="py-9">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        ...
                                                        <span class="text-muted"><?php echo $_smarty_tpl->tpl_vars['user']->value->email;?>
</span>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="font-weight-bold mr-2">Registration time:</span>
                                                        <span class="text-muted"><?php echo $_smarty_tpl->tpl_vars['user']->value->reg_date;?>
</span>
                                                    </div>
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <span class="font-weight-bold mr-2">Overdue account:</span>
                                                        <span class="text-muted"><?php echo $_smarty_tpl->tpl_vars['user']->value->expire_in;?>
</span>
                                                    </div>
                                                </div>
                                                <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                    ...
                                                    <div class="navi-item mb-2">
                                                        <a href="/user/setting/relay" class="navi-link py-4">
                                                            ...
                                                            <span class="navi-text">Node transit</span>
                                                        </a>
                                                    </div>
                                                    <?php }?>
                                                    <div class="navi-item mb-2">
