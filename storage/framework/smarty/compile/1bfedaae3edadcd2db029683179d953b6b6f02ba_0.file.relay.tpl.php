<?php
/* Smarty version 3.1.47, created on 2022-12-04 05:07:54
  from '/www/wwwroot/EZvpn/main-panel/resources/views/metron/user/settings/relay.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.47',
  'unifunc' => 'content_638bbaaa9a1ed6_45489314',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1bfedaae3edadcd2db029683179d953b6b6f02ba' => 
    array (
      0 => '/www/wwwroot/EZvpn/main-panel/resources/views/metron/user/settings/relay.tpl',
      1 => 1670092670,
      2 => 'file',
    ),
  ),
...
function content_638bbaaa9a1ed6_45489314 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>Node transit &mdash; <?php echo $_smarty_tpl->tpl_vars['config']->value["appName"];?>
</title>
...
"><strong>The new node transfer rules</strong></h5>
            </div>
...
<div class="modal fade" id="edit-relay-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title <?php echo $_smarty_tpl->tpl_vars['style']->value[$_smarty_tpl->tpl_vars['theme_style']->value]['modal']['text_title'];?>
"><strong>Edit interim rules</strong></h5>
            </div>
            <div class="modal-body">
                <div class="form-group mb-2">
                    <label class="col-form-label text-lg-right text-left">The origin of nodes:</label>
